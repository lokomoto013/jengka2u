...
import com.example.jengka2u.ViewHolder.ProductViewHolder;
import com.example.jengka2u.model.Product;
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerAdapter<Product , ProductViewHolder> adapter =
                new FirebaseRecyclerAdapter<Product, ProductViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int positions, @NonNull Product model)
                    {
